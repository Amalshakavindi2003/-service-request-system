...
const { createServiceRequest, getUserRequests, getAllServiceRequests, updateStatus, deleteRequest, addCommentToRequest, getRequestComments, getSystemAnalytics } = require('../controllers/requestController');
...
router.post('/:requestId/comments', [body('text').trim().notEmpty().withMessage('Comment text is required')], validateRequest, addCommentToRequest);
